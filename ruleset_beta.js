...
submarine = new aquaUnit(
	...
	mobility: 7,
	vision: 2,
	attack: { GL: 4, GH: 5, AIR: 5, AQUA: 5, AMPHI: 4},
...
skimmer = new aquaUnit(
	...
	mobility: 10,
	vision: 4,
	attack: { GL: 5, GH: 5, AIR: 0, AQUA: 5, AMPHI: 5},
...
sapiens = [marine, mecha2, engineer, marauder, bopper, tank, helicopter, battery, destroyer, fuze, submarine];
for (u in sapiens) sapiens[u].race='sapiens';
titans = [mecha, cyberUnderling, assimilator, speeder, guardian, plasmaTank, eclipse, walker, hydronaut, mantisse, skimmer];
for (u in titans) titans[u].race='titans';
khraleans = [underling, infectedMarine, infector, borfly, swarmer, garuda, pinzer, wyrm, leviathan, salamander, kraken];
