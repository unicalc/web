...
function basicUnit(data) {
	this.armorPiercing = { GL: 0, GH: 0, AIR: 0, AQUA: 0};
	this.minRange = 1;
	this.maxRange = 1;
...
function supportUnit(data) {
	...
	this.attack = { GL: 0, GH: 0, AIR: 0, AQUA: 0};
	this.minRange = 0;
	this.maxRange = 0;
	this.defense = 0;
...
guardian = new groundLightUnit(
	...
	mobility: 10,
	vision: 2,
	attack: { GL: 7, GH: 7, AIR: 8, AQUA: 7},
	armorPiercing: { GL: 0, GH: 0.45, AIR: 0, AQUA: 0.45},
	minRange: 1,
	maxRange: 2,
	defense: 3,
	repair: 0});
...
sapiens = [marine, mecha2, engineer, marauder, bopper, tank, helicopter, battery, destroyer];
for (u in sapiens) sapiens[u].race='sapiens';
titans = [mecha, cyberUnderling, assimilator, speeder, guardian, plasmaTank, eclipse, walker, hydronaut];
for (u in titans) titans[u].race='titans';
khraleans = [underling, infectedMarine, infector, borfly, swarmer, garuda, pinzer, wyrm, leviathan];
